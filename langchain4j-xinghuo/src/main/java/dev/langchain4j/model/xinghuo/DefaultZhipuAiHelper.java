...
import dev.langchain4j.model.xinghuo.chat.AssistantMessage;
import dev.langchain4j.model.xinghuo.chat.ChatCompletionResponse;
import dev.langchain4j.model.xinghuo.chat.Function;
import dev.langchain4j.model.xinghuo.chat.FunctionCall;
import dev.langchain4j.model.xinghuo.chat.Message;
import dev.langchain4j.model.xinghuo.chat.Parameters;
import dev.langchain4j.model.xinghuo.chat.Tool;
import dev.langchain4j.model.xinghuo.chat.ToolCall;
import dev.langchain4j.model.xinghuo.chat.ToolMessage;
import dev.langchain4j.model.xinghuo.chat.ToolType;
import dev.langchain4j.model.xinghuo.embedding.EmbeddingResponse;
import dev.langchain4j.model.xinghuo.shared.Usage;
...
class DefaultZhipuAiHelper {
    ...
    private static Message toZhipuAiMessage(ChatMessage message) {
        ...
        if (message instanceof SystemMessage) {
            ...
            return dev.langchain4j.model.xinghuo.chat.SystemMessage.builder()
        ...
        if (message instanceof UserMessage) {
            ...
            return dev.langchain4j.model.xinghuo.chat.UserMessage.builder()
